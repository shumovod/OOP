...
Field FieldCreator::level_one() {
    ...
    field.get_cell(3, 4).set_event(event_s_.create());
    field.get_cell(2, 0).set_event(event_h_.create());
...
Field FieldCreator::level_two() {
    ...
    field.get_cell(3, 0).set_event(event_s_.create());
    field.get_cell(4, 4).set_event(event_h_.create());
